...
class InformationCreateUpdateSerializer(serializers.Serializer):
    ...
    mtv_index = serializers.CharField(max_length=100, allow_blank=True)
    location_on_server = serializers.CharField(max_length=250, allow_blank=True)
    ...
    summary = serializers.CharField(max_length=3000, allow_blank=True)
